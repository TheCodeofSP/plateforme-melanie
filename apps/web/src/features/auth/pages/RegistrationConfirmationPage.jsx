  ...
  return (
    <>
      <SEO
        ...
        description="Finalise la création de ton compte."
        noIndex
      />
      <main className="registration-page">
        <section className="registration-card registration-result">
          ...
          {hasContext ? (
            <>
              <p>{registrationContent.confirmation.adult}</p>
              <p className="registration-result__email">
                Message envoyé à <strong>{maskEmail(state.email)}</strong>
              </p>
              {!state.emailsAccepted && (
                <p className="registration-notice">
                  {registrationContent.confirmation.emailFailure}
                </p>
              )}
            ...
            <>
              <p>
                Cette page s’affiche après la création d’un compte. Tu peux
                commencer ton inscription ou demander un nouveau lien si ton
                compte existe déjà.
              </p>
