...
export default function RegistrationConsentsStep({
  content,
  errors,
  onChange,
  values,
  ...
  return (
    <fieldset className="registration-step">
      ...
      <div className="registration-consents">
        ...
        <Consent
          name="hasAcknowledgedPrivacyPolicy"
          value={values.hasAcknowledgedPrivacyPolicy}
          onChange={onChange}
          error={errors.hasAcknowledgedPrivacyPolicy}
        >
        ...
        <Consent
          ...
          value={values.newsletterConsent}
          onChange={onChange}
        ...
        <Consent
          ...
          value={values.commercialEmailConsent}
          onChange={onChange}
        >
          J’accepte de recevoir des informations sur les accompagnements et les
          événements proposés par Mélanie.
        </Consent>
      </div>
    </fieldset>
  );
