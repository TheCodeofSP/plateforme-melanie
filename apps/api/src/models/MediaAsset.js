...
const schema = new mongoose.Schema({
  ...
  safePlacePost: { type: mongoose.Schema.Types.ObjectId, ref: "SafePlacePost", default: null, index: true },
  webinar: { type: mongoose.Schema.Types.ObjectId, ref: "Webinar", default: null, index: true },
  communication: { type: mongoose.Schema.Types.ObjectId, ref: "Communication", default: null, index: true },
  purpose: { type: String, enum: ["COVER", "PDF", "AUDIO", "VIDEO", "PROFILE_PHOTO", "SAFE_PLACE_IMAGE", "WEBINAR_IMAGE", "COMMUNICATION_IMAGE"], required: true },
