...
const schema = new mongoose.Schema({
  ...
  parent: { type: mongoose.Schema.Types.ObjectId, ref: "ResourceComment", default: null, index: true },
  content: { type: String, required: true, trim: true, minlength: 1, maxlength: 2000 },
  deletionState: { type: String, enum: ["VISIBLE", "AUTHOR_DELETED", "MODERATED"], default: "VISIBLE", index: true },
