...
const versionSchema = new mongoose.Schema(
  {
    ...
    sourceMode: {
      type: String,
      enum: ["HOSTED", "EXTERNAL", "MIXED", "TEXT"],
      default: "TEXT",
    },
    media: {
      type: mongoose.Schema.Types.ObjectId,
    ...
    authorName: { type: String, trim: true, maxlength: 160, default: null },
...
resourceSchema.index({
  ...
  "publishedVersion.description": "text",
  "publishedVersion.keywords": "text",
  "publishedVersion.blocks.text": "text",
});
resourceSchema.index({
  publicationStatus: 1,
  scheduledFor: 1,
  "publishedVersion.categories": 1,
});
