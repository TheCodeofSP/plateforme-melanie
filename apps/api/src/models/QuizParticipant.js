...
const quizParticipantSchema = new mongoose.Schema({
  ...
  latestAttempt: { type: mongoose.Schema.Types.ObjectId, ref: "QuizAttempt", default: null },
  currentSpmProfile: { type: String, enum: SPM_PROFILES, default: null },
  marketingSync: {
    status: { type: String, enum: ["NOT_REQUESTED", "PENDING", "SYNCED", "FAILED"], default: "NOT_REQUESTED" },
