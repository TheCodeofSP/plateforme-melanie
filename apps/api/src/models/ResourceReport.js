...
const schema = new mongoose.Schema({
  ...
  comment: { type: mongoose.Schema.Types.ObjectId, ref: "ResourceComment", default: null },
  reason: { type: String, enum: REPORT_REASONS, required: true },
  details: { type: String, trim: true, maxlength: 2000, default: null },
  status: { type: String, enum: ["OPEN", "REJECTED", "RESOLVED"], default: "OPEN", index: true },
  resolution: { type: String, enum: ["NONE", "CONTENT_KEPT", "CORRECTION_REQUESTED", "COMMENT_REMOVED", "RESOURCE_UNPUBLISHED", "RESOURCE_ARCHIVED"], default: "NONE" },
...
schema.index({ reporter: 1, targetType: 1, resource: 1, comment: 1, status: 1 });
