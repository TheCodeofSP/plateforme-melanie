...
professionalProfileSchema.index({
  publicationStatus: 1,
  "publishedVersion.profession": 1,
});
professionalProfileSchema.index({
  "publishedVersion.professionalName": "text",
  "publishedVersion.profession": "text",
  "publishedVersion.specialties": "text",
});
