...
async function seed(password) {
  ...
  const memberWithoutQuiz = await upsertUser(
    "member-no-quiz",
    {
      ...common,
  ...
  const minor = await upsertUser(
    "member-minor",
    {
      ...common,
      email: "minor.fixture@example.test",
      firstName: "Mineure",
      pseudonym: "mineure-fixture",
      role: "MEMBER",
  ...
  const intervenant = await upsertUser(
    "intervenant",
    {
      ...common,
  ...
  const pendingIntervenant = await upsertUser(
    "intervenant-pending",
    {
      ...common,
