...
router.get(
  "/reports/:reportId",
  validateParams(v.reportIdSchema),
  reports.detail,
);
router.post(
...
router.post(
  "/reports/:reportId/keep",
  validateParams(v.reportIdSchema),
  validateBody(v.adminReasonSchema),
  reports.keep,
);
router.post(
  "/reports/:reportId/hide",
  validateParams(v.reportIdSchema),
  validateBody(v.adminReasonSchema),
  reports.hide,
);
...
router.post(
  "/reports/:reportId/close-discussion",
  validateParams(v.reportIdSchema),
  validateBody(v.adminReasonSchema),
  reports.close,
);
router.post(
  "/reports/:reportId/suspend-author",
  validateParams(v.reportIdSchema),
  validateBody(v.suspendSchema),
  reports.suspend,
);

router.post(
  "/posts/:postId/request-correction",
  validateParams(v.postIdSchema),
  validateBody(v.adminReasonSchema),
  mod.requestPostCorrection,
);
router.post(
  "/posts/:postId/close",
  validateParams(v.postIdSchema),
...
router.patch(
  ...
  validateParams(v.postIdSchema),
  validateBody(v.moveCategorySchema),
  mod.move,
);
router.put(
  "/posts/:postId/warning",
  validateParams(v.postIdSchema),
  validateBody(v.warningSchema),
  mod.warning,
);
router.delete(
  "/posts/:postId/warning",
...
router.post(
  "/posts/:postId/correction-decision",
  validateParams(v.postIdSchema),
  validateBody(v.correctionDecisionSchema),
  mod.postCorrection,
);
router.get(
...
router.post(
  "/comments/:commentId/request-correction",
  validateParams(v.commentIdSchema),
  validateBody(v.adminReasonSchema),
  mod.requestCommentCorrection,
);
router.post(
...
router.post(
  "/comments/:commentId/correction-decision",
  validateParams(v.commentIdSchema),
  validateBody(v.correctionDecisionSchema),
  mod.commentCorrection,
);
router.get(
...
router.get(
  "/suspensions",
  validateQuery(v.suspensionListSchema),
  suspensions.list,
);
router.post(
  "/users/:userId/suspend",
  validateParams(v.userIdSchema),
  validateBody(v.suspendSchema),
  suspensions.suspend,
);
router.post(
  "/suspensions/:suspensionId/lift",
  validateParams(v.suspensionIdSchema),
  validateBody(v.optionalReasonSchema),
  suspensions.lift,
);
router.get(
