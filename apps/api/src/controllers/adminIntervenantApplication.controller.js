...
async function getPendingApplications(req, res, next) {
  try {
    const applications = await getPendingIntervenantApplications();
...
async function getApplication(req, res, next) {
  try {
    const application = await getIntervenantApplicationForAdmin(
...
async function decideApplication(req, res, next) {
  try {
    const application = await decideIntervenantApplication({
