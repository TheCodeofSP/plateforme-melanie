...
const consentSchema = z.object({
  spmDataProcessing: z.literal(true, { error: "Le traitement des réponses doit être accepté." }),
  resultEmail: z.literal(true, { error: "L’envoi du résultat doit être accepté." }),
