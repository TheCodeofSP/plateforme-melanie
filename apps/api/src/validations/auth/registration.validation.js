...
const registerSchema = z.object({
  ...
  pseudonym: z
    ...
    .max(30)
    .regex(/^[\p{L}\p{N} _'’-]+$/u, "Le pseudonyme contient des caractères non autorisés."),
  isAdultConfirmed: z.literal(true, {
    error: "La création d’un compte est réservée aux personnes majeures dans cette version.",
  }),
